...
gs = pd.read_csv("data/HistoricalData_AASVIXX.csv", header=0, index_col=0, parse_dates=[0], date_format=parser)
gbpusd = pd.read_csv("data/HistoricalData_GBPUSD.csv", header=0, index_col=0, parse_dates=[0], date_format=parser)
...
usdjpy = pd.read_csv("data/HistoricalData_USDJPY.csv", header=0, index_col=0, parse_dates=[0], date_format=parser)
...
data['gs'] = gs['Close/Last']
data['meta'] = meta['Close/Last']
data['msft'] = msft['Close/Last']
data['spx'] = spx['Close/Last']
data['gbpusd'] = gbpusd['Close/Last']
data['usdjpy'] = usdjpy['Close/Last']
